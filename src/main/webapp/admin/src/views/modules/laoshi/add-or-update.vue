        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.laoshiPhoto" label="头像" prop="laoshiPhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.laoshiPhoto" label="头像" prop="laoshiPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="laoshiPhone">
                       <el-input v-model="ruleForm.laoshiPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.laoshiPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="联系方式" prop="laoshiPhone">
                           <el-input v-model="ruleForm.laoshiPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="laoshiEmail">
                       <el-input v-model="ruleForm.laoshiEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.laoshiEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="邮箱" prop="laoshiEmail">
                           <el-input v-model="ruleForm.laoshiEmail"
