               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教室编号" prop="jiaoshiUuidNumber">
                       <el-input v-model="ruleForm.jiaoshiUuidNumber"
                                 placeholder="教室编号" clearable  :readonly="ro.jiaoshiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教室标题" prop="jiaoshiName">
                       <el-input v-model="ruleForm.jiaoshiName"
                                 placeholder="教室标题" clearable  :readonly="ro.jiaoshiName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="教室类型" prop="jiaoshiTypes">
                        <el-select v-model="ruleForm.jiaoshiTypes" :disabled="ro.jiaoshiTypes" placeholder="请选择教室类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="教室状态" prop="jiaoshiStatusTypes">
                        <el-select v-model="ruleForm.jiaoshiStatusTypes" :disabled="ro.jiaoshiStatusTypes" placeholder="请选择教室状态">
                            <el-option
                                v-for="(item,index) in jiaoshiStatusTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教室地址" prop="jiaoshiAddress">
                       <el-input v-model="ruleForm.jiaoshiAddress"
                                 placeholder="教室地址" clearable  :readonly="ro.jiaoshiAddress"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教室容纳量" prop="jiaoshiRongnaliang">
                       <el-input v-model="ruleForm.jiaoshiRongnaliang"
                                 placeholder="教室容纳量" clearable  :readonly="ro.jiaoshiRongnaliang"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="教室详情" prop="jiaoshiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoshiContent" label="教室详情" prop="jiaoshiContent">
                            <span v-html="ruleForm.jiaoshiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    jiaoshiName: false,
                    jiaoshiTypes: false,
                    jiaoshiStatusTypes: false,
                    jiaoshiPhoto: false,
                    jiaoshiAddress: false,
                    jiaoshiRongnaliang: false,
                    jiaoshiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                ...
                jiaoshiTypesOptions : [],
                jiaoshiStatusTypesOptions : [],
                rules: {
                   jiaoshiUuidNumber: [
                              { required: true, message: '教室编号不能为空', trigger: 'blur' },
                          ],
                   jiaoshiName: [
                              { required: true, message: '教室标题不能为空', trigger: 'blur' },
                          ],
                   jiaoshiTypes: [
                   ...
                   jiaoshiStatusTypes: [
                              { required: true, message: '教室状态不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   jiaoshiPhoto: [
                              { required: true, message: '教室图片不能为空', trigger: 'blur' },
                          ],
                   jiaoshiAddress: [
                              { required: true, message: '教室地址不能为空', trigger: 'blur' },
                          ],
                   jiaoshiRongnaliang: [
                              { required: true, message: '教室容纳量不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   jiaoshiContent: [
                              { required: true, message: '教室详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaoshi_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiaoshiStatusTypesOptions = data.data.list;
                    }
                });
