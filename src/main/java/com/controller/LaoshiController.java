...
public class LaoshiController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params.put("laoshiDeleteStart",1);params.put("laoshiDeleteEnd",1);
...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids){
        ...
        ArrayList<LaoshiEntity> list = new ArrayList<>();
        for(Integer id:ids){
            LaoshiEntity laoshiEntity = new LaoshiEntity();
            laoshiEntity.setId(id);
            laoshiEntity.setLaoshiDelete(2);
            list.add(laoshiEntity);
        }
        if(list != null && list.size() >0){
            laoshiService.updateBatchById(list);
        }
        return R.ok();
    }
...
//                            laoshiEntity.setLaoshiPhone(data.get(0));                    //联系方式 要改的
//                            laoshiEntity.setLaoshiEmail(data.get(0));                    //邮箱 要改的
//                            laoshiEntity.setLaoshiDelete(1);//逻辑删除字段
//                            laoshiEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //账户
                        List<LaoshiEntity> laoshiEntities_username = laoshiService.selectList(new EntityWrapper<LaoshiEntity>().in("username", seachFields.get("username")).eq("laoshi_delete", 1));
                        if(laoshiEntities_username.size() >0 ){
                         ...
                         //联系方式
                        List<LaoshiEntity> laoshiEntities_laoshiPhone = laoshiService.selectList(new EntityWrapper<LaoshiEntity>().in("laoshi_phone", seachFields.get("laoshiPhone")).eq("laoshi_delete", 1));
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(laoshi.getLaoshiDelete() != 1)
