    ...
    */
    ...
    public R save(@RequestBody JiaoshiEntity jiaoshi, HttpServletRequest request){
        ...
        Wrapper<JiaoshiEntity> queryWrapper = new EntityWrapper<JiaoshiEntity>()
            ...
            .eq("jiaoshi_status_types", jiaoshi.getJiaoshiStatusTypes())
            .eq("jiaoshi_address", jiaoshi.getJiaoshiAddress())
            .eq("jiaoshi_rongnaliang", jiaoshi.getJiaoshiRongnaliang())
            ;
...
//                            jiaoshiEntity.setJiaoshiName(data.get(0));                    //教室标题 要改的
//                            jiaoshiEntity.setJiaoshiTypes(Integer.valueOf(data.get(0)));   //教室类型 要改的
//                            jiaoshiEntity.setJiaoshiStatusTypes(Integer.valueOf(data.get(0)));   //教室状态 要改的
//                            jiaoshiEntity.setJiaoshiPhoto("");//照片
//                            jiaoshiEntity.setJiaoshiAddress(Integer.valueOf(data.get(0)));   //教室地址 要改的
//                            jiaoshiEntity.setJiaoshiRongnaliang(Integer.valueOf(data.get(0)));   //教室容纳量 要改的
